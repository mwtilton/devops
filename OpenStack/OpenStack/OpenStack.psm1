...
Import-Module "$PSScriptRoot\OpenStack.Machine.ps1" -Force -ErrorAction Stop
############################################################################
...
#>
    ...
    Else {
        $openrc = $args[0]
        $error = "The file you specified doesn't seem to"
        ...
        Else {
            Write-Host @($error + " have an OS_TENANT_NAME")
            Exit
        }
        <#
        ...
        Else {
            Write @($error + " have an OS_TENANT_ID")
            Exit
        }
        #>
        ...
        Else {
            Write @($error + " have an OS_AUTH_URL")
            Exit
        }
        ...
        Else {
            Write @($error + " have an OS_USERNAME")
            Exit
        }
